...
const theme = {
  ...
  themes: {
    light: {
      dark: false,
      colors: {
        'primary': localStorage.getItem(`${themeConfig.app.title}-lightThemePrimaryColor`) || '#FF0090',
        'on-primary': '#F3FCFE',
        'secondary': '#A8AAAE',
        'on-secondary': '#fff',
        'success': '#6FDDEF',
    ...
    dark: {
      dark: true,
      colors: {
        'primary': localStorage.getItem(`${themeConfig.app.title}-darkThemePrimaryColor`) || '#FF0090',
        'on-primary': '#F3FCFE',
        'secondary': '#A8AAAE',
        'on-secondary': '#fff',
        'success': '#6FDDEF',
